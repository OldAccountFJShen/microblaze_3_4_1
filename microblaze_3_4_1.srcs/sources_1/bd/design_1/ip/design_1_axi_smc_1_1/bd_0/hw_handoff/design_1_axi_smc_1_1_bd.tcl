...
################################################################
# This is a generated script based on design: bd_68b9
#
...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SEG000_BASE_ADDR {0x00000000C0000000} \
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC004_ROUTE {0b0} \
   CONFIG.SSC005_ROUTE {0b0} \
   CONFIG.SSC006_ROUTE {0b0} \
   CONFIG.SSC007_ROUTE {0b0} \
   CONFIG.SSC008_ROUTE {0b0} \
   CONFIG.SSC009_ROUTE {0b0} \
   CONFIG.SSC010_ROUTE {0b0} \
   CONFIG.SSC011_ROUTE {0b0} \
   CONFIG.SSC012_ROUTE {0b0} \
   CONFIG.SSC013_ROUTE {0b1} \
   CONFIG.SSC014_ROUTE {0b0} \
   CONFIG.SSC015_ROUTE {0b0} \
   CONFIG.SSC016_ROUTE {0b0} \
   CONFIG.SSC017_ROUTE {0b0} \
   CONFIG.SSC018_ROUTE {0b0} \
   CONFIG.SSC019_ROUTE {0b0} \
   CONFIG.SSC020_ROUTE {0b0} \
   CONFIG.SSC021_ROUTE {0b0} \
   CONFIG.SSC022_ROUTE {0b0} \
   CONFIG.SSC023_ROUTE {0b0} \
   CONFIG.SSC024_ROUTE {0b0} \
   CONFIG.SSC025_ROUTE {0b0} \
   CONFIG.SSC026_ROUTE {0b0} \
   CONFIG.SSC027_ROUTE {0b0} \
   CONFIG.SSC028_ROUTE {0b0} \
   CONFIG.SSC029_ROUTE {0b0} \
   CONFIG.SSC030_ROUTE {0b0} \
   CONFIG.SSC031_ROUTE {0b0} \
