...
HD_PWD='D:/HUST_study/FPGA_based_DSP/microblaze_3_4/microblaze_3_4.runs/design_1_xlconstant_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlconstant_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlconstant_0_6.tcl
