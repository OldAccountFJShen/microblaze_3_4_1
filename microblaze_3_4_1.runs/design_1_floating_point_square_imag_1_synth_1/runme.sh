...
HD_PWD='D:/HUST_study/FPGA_based_DSP/microblaze_3_4_1/microblaze_3_4_1.runs/design_1_floating_point_square_imag_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_floating_point_square_imag_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_floating_point_square_imag_1.tcl
