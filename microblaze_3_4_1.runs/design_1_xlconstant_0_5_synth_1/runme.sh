...
HD_PWD='D:/HUST_study/FPGA_based_DSP/microblaze_3_3/microblaze_3_3.runs/design_1_xlconstant_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlconstant_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlconstant_0_5.tcl
